                    ...
                    <div class="input-group mt-4 mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1">
                                <svg class="mr-1" width="30" height="24" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                        ...
                        <input type="text" class="form-control p-2 wedlvr pr-5" placeholder="Enter Mobile Number" id="change_mobile_number" value="<?=$this->session->userdata('customer_mobile')?>">
                        <button class="chngbtn" type="button" id="btn_change_mobile_number">Change</button>
                    </div>

                    <small class="housdel d-block mb-3">Please enter 4-digit verification code which we sent on <br> your mobile number.</small>
                    <div class="bmcoptsec">
                        <div class="d-flex flex-row mt-3 otpsec">
                            <input type="text" id="otp1" class="form-control" autofocus="">
                        ...
                        <div class="text-center d-flex align-items-center justify-content-between mt-3">
                            ...
                            <span class="font-weight-bold txtgrn" id="resend_otp" style="cursor:pointer">Resend</span>
                        </div>
                    </div>

                    <div class="bmcsingup">
                        <button  class="btn grnbtn rounded text-white" type="button" id="btn_verify_otp">Signup Now!</button>
                    </div>
