...
<body>
    ...
    <section class="container">
        <div class="usecodesec my-3 p-3 shadow-sm">
            <h3 class="mb-2">50% off on your first order!</h3>
            <div class="mb-2">Order above ₹200 *max discount ₹100</div>
            <big class="d-block">USE CODE: <strong>blinkit</strong></big>
        </div>
    </section>


    <div class="mainwrp active bg-light">
        <div class="homebanner mb-4">
            <img src="<?= base_url('assets/customer/') ?>images/homebanner1.jpg" alt="" class="w-100">
        </div>
        <div class="container">
            <div class="row mb-4">
                <div class="col-md-4 mb-4 text-center col-4">
                    <a href="<?= base_url('restaurant') ?>" class="d-block h-100 rounded shadow-sm bg-white">
                        <img src="<?= base_url('assets/customer/') ?>images/Food.jpg" alt="" class="img-fluid">
                        <h4 class="bg-white py-2">Food</h4>
                    </a>
                </div>
                <div class="col-md-4 mb-4 text-center col-4">
                    <a href="<?= base_url('shop') ?>" class="d-block h-100 rounded shadow-sm bg-white">
                        <img src="<?= base_url('assets/customer/') ?>images/Shop.jpg" alt="" class="img-fluid">
                        <h4 class="bg-white py-2">Shop</h4>
                    </a>
                </div>
                <div class="col-md-4 mb-4 text-center col-4">
                    <a href="<?= base_url('store') ?>" class="d-block h-100 rounded shadow-sm bg-white">
                        <img src="<?= base_url('assets/customer/') ?>images/Storewise.jpg" alt="" class="img-fluid">
                        <h4 class="bg-white py-2">Storewise</h4>
                    </a>
                </div>
                <div class="col-md-4 mb-4 text-center col-4">
                    <a href="parcel.html" class="d-block h-100 rounded shadow-sm bg-white">
                        <img src="<?= base_url('assets/customer/') ?>images/Parcel.jpg" alt="" class="img-fluid">
                        <h4 class="bg-white py-2">Parcel</h4>
                    </a>
                </div>
                <div class="col-md-4 mb-4 text-center col-4">
                    <a href="tel:0000000000" class="d-block h-100 rounded shadow-sm bg-white">
                        <img src="<?= base_url('assets/customer/') ?>images/Order-on-Call.jpg" alt="" class="img-fluid">
                        <h4 class="bg-white py-2">Order on Call</h4>
                    </a>
                </div>
                <div class="col-md-4 mb-4 text-center col-4">
                    <a href="on-demand-services.html" class="d-block h-100 rounded shadow-sm bg-white">
                        <img src="<?= base_url('assets/customer/') ?>images/Services.jpg" alt="" class="img-fluid">
                        <h4 class="bg-white py-2">Services</h4>
                    </a>
                </div>
            </div>
            <div class="row">
                <div class="col-6 col-md-6 col-lg-3 mb-4">
                    <a href="#" class="d-block">
                        <img src="<?= base_url('assets/customer/') ?>images/21.webp" alt="" class="w-100">
                    </a>
                </div>
                <div class="col-6 col-md-6 col-lg-3 mb-4">
                    <a href="#" class="d-block">
                        <img src="<?= base_url('assets/customer/') ?>images/22.webp" alt="" class="w-100">
                    </a>
                </div>
                <div class="col-6 col-md-6 col-lg-3 mb-4">
                    <a href="#" class="d-block">
            ...
            <div class="row mb-5">
                <div class="col-md-6 mb-4">
                    <a href="#" class="d-block">
                        <img src="<?= base_url('assets/customer/') ?>images/13.webp" alt="" class="w-100">
                    </a>
                </div>
                <div class="col-md-6 mb-4">
                    <a href="#" class="d-block">
                        <img src="<?= base_url('assets/customer/') ?>images/14.webp" alt="" class="w-100">
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <div class="cartlistfxdwrp">
                        ...
                        <div class="cartlistfxdinr">
                            ...
                            <div class="prodlistwwrp">
                                <div class="prodlist mb-3 shadow-sm p-2 bg-light">
                                    <div class="row row5">
                                        <div class="col-3">
