            ...
            <div class="col-md-6 p-0 p-lg-3">
                <div class=" text-center wlcm">
                    ...
                    <div class="input-group my-4">
                        ...
                        <input type="text" class="form-control p-2 wedlvr" placeholder="Enter Mobile Number" id="mobile_number">
                    </div>
                    <small class="housdel d-block mb-5">We will send you 4-digit Verification code at <br> your mobile number!</small>
                    <div class="mobinfo tmsc mb-3">
                        By Signing Up, I agree to all <a href="#" target="_blank"> Terms and Conditions</a> of Bikrimart.
                    </div>
                    <div class="bmcsingup">
                        <a class="btn grnbtn rounded text-white" type="button" id="btn_send_otp">Signup Now!</a>
                    </div>
                </div>
            </div>
        </div>
